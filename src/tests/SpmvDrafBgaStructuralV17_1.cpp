    ...
    double gpu_ms, double target_speedup, double tck_ns)
{
    ...
    /*
     * V17-1 keeps the V17 regular-leakage gate structure, but makes the
     * leakage response slightly stronger for regular false-positive workloads.
     */
    ...
    result.v17_1_soft_alpha = soft_alpha;
    result.v17_1_true_high_speedup_candidate_score = true_high_speedup_candidate_score;
    result.v17_1_regular_false_positive_score = regular_false_positive_score;
    result.v17_1_graph_like_penalty_score = graph_like_penalty_score;
    result.v17_1_regular_leakage_score = regular_leakage_score;
    result.v17_1_high_confidence_protection_score = high_confidence_protection_score;
    result.v17_1_regular_soft_alpha_cap = regular_soft_alpha_cap;
    result.v17_1_saving_budget_cycle = saving_budget;
    result.v17_1_saving_demand_cycle = saving_demand;
    result.v17_1_effective_saving_cycle = effective_saving;
    result.v17_1_protected_bga_hidden_cycle = protected_bga_hidden;
    result.v17_1_final_bounded_bga_hidden_cycle = bounded_bga_hidden;
    ...
    cout << "> soft_saving_budget: budget=" << saving_budget
         ...
         << " saturation_ratio=" << result.v17_1_budget_saturation_ratio << endl;
    ...
    cout << variant_spec.result_csv_tag
         ...
         << bounded_bga_hidden << "," << result.v17_1_budget_saturation_ratio
         << endl;
    return result;
}
