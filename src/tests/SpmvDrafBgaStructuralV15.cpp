...
StructuralModelResult runDrafBgaStructuralModelV15(
    ...
    double gpu_ms, double target_speedup, double tck_ns)
{
    ...
    result.v15_soft_alpha = soft_alpha;
    result.v15_true_high_speedup_candidate_score = true_high_speedup_candidate_score;
    result.v15_regular_false_positive_score = regular_false_positive_score;
    result.v15_graph_like_penalty_score = graph_like_penalty_score;
    result.v15_saving_budget_cycle = saving_budget;
    result.v15_saving_demand_cycle = saving_demand;
    result.v15_effective_saving_cycle = effective_saving;
    result.v15_protected_bga_hidden_cycle = protected_bga_hidden;
    result.v15_final_bounded_bga_hidden_cycle = bounded_bga_hidden;
    ...
    cout << "> soft_saving_budget: budget=" << saving_budget
         ...
         << " saturation_ratio=" << result.v15_budget_saturation_ratio << endl;
    ...
    cout << variant_spec.result_csv_tag
         ...
         << bounded_bga_hidden << "," << result.v15_budget_saturation_ratio
         << endl;
    return result;
}
