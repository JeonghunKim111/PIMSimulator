...
{
    /*
     * BV-1 restarts from a plain structural baseline:
     *   1. GEMV-like sparse MAC slots from packed DRAF NZE capacity.
     *   2. DRAF row fetch/trigger traffic measured by DRAMSim.
     *   3. BGA accumulation/readback and final host reduction.
     *
     * No overlap, target fitting, or workload-class correction is applied here.
     */
    ...
    cout << "  latency_scope: GEMV-like sparse compute + DRAF fetch/trigger"
